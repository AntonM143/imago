...
const about = () => {
  return (
    <div>
    <div className={styles.kopvilkor}>
      <h1>Köpvilkor</h1>
      <ol>
    <li>
        <strong>Om Imago</strong>
    </li>
</ol>
<ul>
    <li>Företaget har sitt säte i Göteborg. Företagets postadress är Danska vägen 11.</li>
    <li>Önskar du att komma i kontakt med oss, skicka ett mail till info@imago.se med ditt ärende och dina kontaktuppgifter så hör vi av oss inom kort.</li>
</ul>
<ol start="2">
    <li>
...
<ul>
    ...
    <li>Är något fel i orderbekräftelsen ska du omedelbart kontakta oss via e-post till info@imago.se.</li>
</ul>
<ol start="3">
    <li>
...
<ul>
    <li>Våra normala leveranstider är 1-4 dagar. OBS! Beställningar lagda på helger skickas tidigast på måndagen efter.</li>
    <li>Om förseningar i leveransen skulle uppstå (utan att vi har meddelat dig om längre leveranstid) ska du kontakta oss på e-postadress: info@imago.se.</li>
</ul>
<ol start="4">
    <li>
...
<ul>
    <li>Alla priser i butiken anges i SEK och alla priser är inklusive 25% moms.</li>
...
<ul>
    ...
    <li>Eventuella fel och defekt ska alltid reklameras till info@imago.se där du anger ditt namn, din adress, e-postadress, ordernummer och en beskrivning av felet.</li>
</ul>
<ul>
...
<ul>
<li>
        Genom att handla hos Imago accepterar du vår dataskyddspolicy och vår behandling av dina personuppgifter. Vi värnar om din personliga integritet och samlar inte in fler uppgifter än nödvändigt för att behandla din beställning.
...
<li>
    Nedan information är en summering av hur vi i enlighet med <a href="https://www.imy.se/verksamhet/dataskydd/det-har-galler-enligt-gdpr/introduktion-till-gdpr/" >dataskyddsförordningen</a> (GDPR) lagrar och behandlar dina uppgifter.
</li>
<li>
...
<li>
    ...
    Imago är ansvarig för lagring och behandling av personuppgifter i webbutiken och ser till att reglerna efterföljs.
</li>
<li>
...
<ul>
    ...
    <div>
      ...
      <p>
        ...
        Vid retur med PostNord kan du lämna in din retur i din närmsta Postnord-ombud. Returetikett finns med i ditt paket vid leverans.
      </p>
    </div>
    </div>
  )
